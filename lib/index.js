...
var htmlLike = new UnexpectedHtmlLike(require('../lib/htmllike').adapter);
...
module.exports = {
  ...
  installInto: function (expect) {
    ...
    expect.exportAssertion('<DOMDocument|DOMElement> to htmllike-equal <DOMDocument|DOMElement>', function (expect, subject, expected) {
      var result = htmlLike.diff(require('../lib/htmllike').adapter, subject, expected, expect);
    ...
    expect.exportAssertion('<DOMElement> to contain element <DOMElement>', function (expect, subject, expected) {
      var result = htmlLike.contains(require('../lib/htmllike').adapter, subject, expected, expect);
